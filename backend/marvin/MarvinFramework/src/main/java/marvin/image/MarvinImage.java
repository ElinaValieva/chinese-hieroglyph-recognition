...
//		arrIntColor = ((DataBufferInt) image.getRaster().getDataBuffer()).getData();
	...
	/**
	 * Draws a rectangle in the image. It愀 useful for debugging purposes.
	 * @param x		rect愀 start position in x-axis
	 * @param y		rect愀 start positioj in y-axis
	 * @param w		rect愀 width
	 * @param h		rect愀 height
	 * @param c		rect愀 color
	 */
